...
export default function CoursesPage() {
  ...
  const courses = [
    ...
    {
      id: 2,
      title: "Web and Mobile Development - Advance",
    ...
    },
    {
      ...
      description: "Expert-level backend development with enterprise solutions",
      duration: "10 weeks",
      level: "Advanced",
      price: "200,000",
      ...
      rating: 4.9,
      students: 1423,
      features: ["Node js", "DevOps Integration", "Python", "Security"],
      popular: true,
    },
    {
      id: 4,
      title: "Graphic Design - Canva Mastery",
      ...
      rating: 4.7,
      students: 2834,
      features: ["Canva Mastery", "Design Principles", "Typography", "Color Theory", "Brand Identity"],
      popular: true,
    },
    // {
    //   id: 5,
    ...
    {
      id: 6,
      title: "Graphic Design - Photoshop (Adobe Part 1)",
    ...
    {
      id: 12,
      title: "WordPress Website Design - Advance",
    ...
    {
      id: 13,
      title: "Microsoft Office Suite & Windows Mastery",
    ...
    // },
    {
      ...
      rating: 4.5,
      students: 3456,
      features: ["Social Media Marketing", "Digital Marketing Strategy", "Digital Marketing Strategy", "Email Marketing", "Content Marketing"],
      popular: true,
    },
    {
      id: 17,
      ...
      rating: 4.7,
      students: 2234,
      features: ["Canva Mastery & Web Building", "Funnel Design", "Campaign Execution", "Client Management & Reporting", "Graphic Design & Video Editing"],
      popular: false,
    },
    // {
    //   id: 18,
    ...
    // },
    {
      ...
      rating: 4.6,
      students: 2145,
      features: ["AI Fundamentals", "Machine Learning Basics", "Prompt Engineering", "Ethics in AI", "AI Applications"],
      popular: false,
    },
    {
      id: 20,
      title: "Artificial Intelligence (AI) - Advance",
    ...
    },
    {
      ...
      rating: 4.5,
      students: 2789,
      features: ["Excel","Excel Dashboard", "Data Collection", "Power BI"],
      popular: true,
    },
    {
      id: 23,
      ...
      rating: 4.7,
      students: 1956,
      features: ["Power BI Dashboard", "Python", "AI for Data Analyst", "SQL"],
      popular: false,
    },
    // {
    //   id: 24,
                      ...
                      <div>
                        <div className="space-y-1">
                          <div className="text-sm">
                            <span className="font-semibold text-foreground">Physical class:</span>{" "}
                            <span className="text-xl font-bold text-primary">{formatPrice(parsePrice(course.price))}
                              {course.originalPrice && (
                          <span className="text-sm text-muted-foreground line-through ml-2">
                            {formatPrice(parsePrice(course.originalPrice))}
                          </span>
                        )}
                            </span>
                          </div>
                          <div className="text-sm text-muted-foreground">
                            <span className="font-semibold text-foreground">Online class:</span>{" "}
                            {formatPrice(parsePrice(course.price) - 20000)}
                          </div>
                          <div className="text-sm text-muted-foreground">
                            <span className="font-semibold text-foreground">Pre-recorded class:</span>{" "}
                            {formatPrice(parsePrice(course.price) - 30000)}
                          </div>
                        </div>
